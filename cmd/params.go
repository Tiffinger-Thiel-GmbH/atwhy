...
func LoadCommon(cmd *cobra.Command) (templates []generator.DocTemplate, project string, extentions []string, htmlTemplate string, err error) {
	...
	return templates, project, extentions, htmlTemplate, nil
}
